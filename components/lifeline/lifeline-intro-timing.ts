...
/**
 * Calibrates the ease so the first LIFELINE_SLOW_YEARS occupy
 * LIFELINE_SLOW_TIME_RATIO of the sweep's wall-clock time — the opening
 * years linger, then the rail accelerates through the rest.
 */
